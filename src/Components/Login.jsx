...
const Login = () => {
  ...
  return (
     <div className="bg-black text-white h-screen">
        ...
        <h1 className="text-wrap text-4xl text-center w-72 font-black ml-auto mr-auto mt-20">Login to start listening the music based on your mood</h1>
        ...
        <button className="outline-none  border-2 border-gray-500 focus:border-white" type="submit">Login</button>
        </div>
        </form>
